...
export const LoaderFour = ({ text = "Loading..." }: { text?: string }) => {
  return (
    <div className="relative font-bold text-black [perspective:1000px] dark:text-white">
      <motion.span
        animate={{
          skewX: [0, -40, 0] as const,
          scaleX: [1, 2, 1] as const,
        }}
        transition={{
          duration: 0.05,
          repeat: Infinity,
      ...
      <motion.span
        ...
        animate={{
          x: [-2, 4, -3, 1.5, -2] as const,
          y: [-2, 4, -3, 1.5, -2] as const,
          opacity: [0.3, 0.9, 0.4, 0.8, 0.3] as const,
        }}
        transition={{
          duration: 0.5,
          repeat: Infinity,
      ...
      <motion.span
        ...
        animate={{
          x: [0, 1, -1.5, 1.5, -1, 0] as const,
          y: [0, -1, 1.5, -0.5, 0] as const,
          opacity: [0.4, 0.8, 0.3, 0.9, 0.4] as const,
        }}
        transition={{
          duration: 0.8,
          repeat: Infinity,
